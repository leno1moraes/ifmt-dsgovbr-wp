    ...
    <div class="row">
        ...
        <div class="col text-center">
            ...
            <div class="fb-page" 
                ...
                <blockquote cite="https://www.facebook.com/100087288608436" 
                            class="fb-xfbml-parse-ignore">
                    <a href="https://www.facebook.com/100087288608436">Pagina teste institucional</a><
                /blockquote>
            </div>
        ...
        <div class="col">            
			...
			data-instgrm-permalink="https://www.instagram.com/p/ChpoffVufF-/?utm_source=ig_embed&amp;utm_campaign=loading" 
			...
			<div style="padding:16px;"> 
				<a href="https://www.instagram.com/p/ChpoffVufF-/?utm_source=ig_embed&amp;utm_campaign=loading" 
					...
					<div style="padding-top: 8px;"> 
						<div style=" color:#3897f0; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:550; line-height:18px;">Ver essa foto no Instagram</div></div>
						...
						<div style="margin-left: 8px;"> 
							...
							<div style="margin-left: auto;"> 
								...
								<p style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; line-height:17px; margin-bottom:0; margin-top:8px; overflow:hidden; padding:8px 0 7px; text-align:center; text-overflow:ellipsis; white-space:nowrap;"><a href="https://www.instagram.com/p/ChpoffVufF-/?utm_source=ig_embed&amp;utm_campaign=loading" style=" color:#c9c8cd; font-family:Arial,sans-serif; font-size:14px; font-style:normal; font-weight:normal; line-height:17px; text-decoration:none;" target="_blank" rel="noopener">Uma publicação compartilhada por Leno Institucional (@lenoinstitucional)</a></p></div></blockquote> <script async="" src="//www.instagram.com/embed.js"></script>            
        ...
        <div class="col text-center">
            <a class="twitter-timeline" 
                data-height="500" 
                href="https://twitter.com/lenoIFMTInst?ref_src=twsrc%5Etfw">Tweets by lenoIFMTInst</a>
        </div>
