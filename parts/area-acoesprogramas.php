<section class="mb-5 my-4x mdgaleitura" style="background: #f8f8f8 no-repeat left bottom; padding: 30px 0">

<div class="content text-center mb-5x mdgaleitura">
    <h2 class="text-blue-warm-vivid-80 text-bold mdgaleitura"> <span class="mdpaleitura">Ações e Programas</span> </h2>
</div>            



<div class="container mdgaleitura">
    <div class="row justify-content-center mdgaleitura"> 

        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="br-card hover mdgaleitura">
                <a href="<?php if ( get_theme_mod( 'set_url_acoesprog1' ) != '' ): echo get_theme_mod( 'set_url_acoesprog1' ); else: echo '#'; endif; ?>">
                    ...
                    <div class="card-footer my-1 text-center text-bold"> <span class="mdsatleitura" style="color: #0c326f;"><?php if ( get_theme_mod( 'set_text_acoesprog1') != '' ): echo get_theme_mod( 'set_text_acoesprog1'); else: echo 'INSERIR TEXTO 1'; endif; ?></span> </div>
                </a>
            </div>
        </div>      
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="br-card hover mdgaleitura">
                <a href="<?php if ( get_theme_mod( 'set_url_acoesprog2' ) != '' ): echo get_theme_mod( 'set_url_acoesprog2' ); else: echo '#'; endif; ?>">
                    ...
                    <div class="card-footer my-1 text-center text-bold"> <span class="mdsatleitura" style="color: #0c326f;"><?php if ( get_theme_mod( 'set_text_acoesprog2') != '' ): echo get_theme_mod( 'set_text_acoesprog2'); else: echo 'INSERIR TEXTO 1'; endif; ?> </span></div>
                </a>
            </div>
        </div>  
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="br-card hover mdgaleitura">
                <a href="<?php if ( get_theme_mod( 'set_url_acoesprog3' ) != '' ): echo get_theme_mod( 'set_url_acoesprog3' ); else: echo '#'; endif; ?>">
                    ...
                    <div class="card-footer my-1 text-center text-bold"> <span class="mdsatleitura" style="color: #0c326f;"><?php if ( get_theme_mod( 'set_text_acoesprog3') != '' ): echo get_theme_mod( 'set_text_acoesprog3'); else: echo 'INSERIR TEXTO 1'; endif; ?> </span></div>
                </a>
            </div>
        </div>  
        ...
        <div class="col-sm-6 col-md-4 col-lg-3">
            <div class="br-card hover mdgaleitura">
                <a href="<?php if ( get_theme_mod( 'set_url_acoesprog4' ) != '' ): echo get_theme_mod( 'set_url_acoesprog4' ); else: echo '#'; endif; ?>">
                    ...
                    <div class="card-footer my-1 text-center text-bold"> <span class="mdsatleitura" style="color: #0c326f;"><?php if ( get_theme_mod( 'set_text_acoesprog4') != '' ): echo get_theme_mod( 'set_text_acoesprog4'); else: echo 'INSERIR TEXTO 1'; endif; ?> </span></div>
                </a>
            </div>
        </div>          
